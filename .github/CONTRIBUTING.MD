...
Run the pre built and configured
...
Check out the `example/` folder to see how RNE is used to build the [React Native Elements App](https://expo.io/@monte9/react-native-elements-app) on Expo.
