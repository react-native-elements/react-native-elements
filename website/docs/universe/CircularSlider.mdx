...
```bash
npm install @react-native-elements/react-native-elements/circular-slider
```
...
```bash
yarn add @react-native-elements/react-native-elements/circular-slider
```

</TabItem>
</Tabs>
react-native-elements/circular-slider
