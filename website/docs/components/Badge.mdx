...
| `badgeStyle`     | View style(Object)                                     |                                                   | Additional styling for badge (background) view component. |
| `containerStyle` | View style(Object)                                     |                                                   | Style for the container.                                  |
...
| `textStyle`      | Text Style(Object)                                     |                                                   | Extra styling for icon component.                         |
