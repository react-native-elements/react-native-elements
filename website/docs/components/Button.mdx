...
import Play from "../playground/Button/button.playground";
...
| `color`               | `StringOmit<primary` or `success` or `warning` or `error` or `secondary>` |         |                                                                                                                                                          |
...
| `radius`              | `string` or `number` or `sm` or `md` or `lg` or `none`                    | `xs`    | Radius of button                                                                                                                                         |
