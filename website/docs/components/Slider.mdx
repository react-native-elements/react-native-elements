...
import Usage from "./usage/Slider.mdx";
...
| `style`                 | View style(Object)                                 |                                             | The style applied to the slider container.                                                                                                                                                                    |
| `thumbProps`            | any                                                |                                             | The props applied to the thumb. Uses `Component` prop which can accept `Animated` components.                                                                                                                 |
| `thumbStyle`            | View style(Object)                                 |                                             | The style applied to the thumb.                                                                                                                                                                               |
...
| `trackStyle`            | View style(Object)                                 |                                             | The style applied to the track.                                                                                                                                                                               |
