...
:::note
Includes all props from [ListItemBaseProps](/docs/documentation/listitembase#props), [ViewProps](https://reactnative.dev/docs/view#props)
:::
...
| `isExpanded` | boolean                        |                                              | Decide if Accordion is Expanded.                                                |
