...
| `activityIndicatorStyle` | View style(Object)                   |                                                   | Style to render when in loading state.                                             |
...
| `fontStyle`              | Text Style(Object)                   |                                                   | Specify text styling.                                                              |
...
| `iconStyle`              | View style(Object)                   |                                                   | Extra styling for icon component.                                                  |
...
| `style`                  | View style(Object)                   |                                                   | Adds styling to the button.                                                        |
