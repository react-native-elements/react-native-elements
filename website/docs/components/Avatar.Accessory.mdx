...
:::note
Includes all props from [IconProps](/docs/documentation/icon#props), [ImageProps](/docs/documentation/image#props), [TextProps](https://reactnative.dev/docs/text#props)
:::
