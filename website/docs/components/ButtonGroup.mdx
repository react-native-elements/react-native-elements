...
| `buttons`                   | `(string` or `ButtonComponent` or `ButtonObject)[]` |                   | Array of buttons for component (required), if returning a component, must be an object with { element: componentName }.              |
