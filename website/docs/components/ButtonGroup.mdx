...
import Usage from "./usage/ButtonGroup.mdx";
...
| `buttonContainerStyle`      | View style(Object)                                                          |                   | Specify styling for button containers.                                                                                               |
| `buttonStyle`               | View style(Object)                                                          |                   | Specify styling for button.                                                                                                          |
...
| `containerStyle`            | View style(Object)                                                          |                   | Specify styling for main button container.                                                                                           |
...
| `disabledSelectedStyle`     | View style(Object)                                                          |                   | Styling for each selected button when disabled.                                                                                      |
| `disabledSelectedTextStyle` | Text Style(Object)                                                          |                   | Styling for the text of each selected button when disabled.                                                                          |
| `disabledStyle`             | View style(Object)                                                          |                   | Styling for each button when disabled.                                                                                               |
| `disabledTextStyle`         | Text Style(Object)                                                          |                   | Styling for the text of each button when disabled.                                                                                   |
...
| `onPress`                   | `((event: GestureResponderEvent) => void)` and `((...args: any[]) => void)` | `Function`        | Called when a single tap gesture is detected.Method to update Button Group Index.                                                    |
...
| `selectedButtonStyle`       | View style(Object)                                                          |                   | Specify styling for selected button.                                                                                                 |
...
| `selectedTextStyle`         | Text Style(Object)                                                          |                   | Specify specific styling for text in the selected state.                                                                             |
| `setOpacityTo`              | (value: number) => void                                                     |                   | Function to set the opacity.                                                                                                         |
| `textStyle`                 | Text Style(Object)                                                          |                   | Specify specific styling for text.                                                                                                   |
