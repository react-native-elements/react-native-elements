...
export const componentMap = {
  ...
  Card: {
    ...
    childrens: [
      ...
      },
      {
        ...
        path: path.join(
          __dirname,
          '../../../src/Card/Card.FeaturedSubtitle.tsx'
        ),
      },
      {
        name: 'FeaturedTitle',
  ...
  // Image: {
  //   name: 'Image',
  //   path: path.join(__dirname, '../../../src/Image/Image.tsx'),
  //   childrens: [],
  // },
  Icon: {
    name: 'Icon',
  ...
  LinearProgress: {
    ...
    path: path.join(
      __dirname,
      '../../../src/LinearProgress/LinearProgress.tsx'
    ),
    childrens: [],
  },
  ListItem: {
    ...
    childrens: [
      {
        ...
        path: path.join(
          __dirname,
          '../../../src/ListItem/ListItem.Accordion.tsx'
        ),
      },
      {
        name: 'ButtonGroup',
      ...
      },
      {
        ...
        path: path.join(
          __dirname,
          '../../../src/ListItem/ListItem.CheckBox.tsx'
        ),
      },
      {
        name: 'Chevron',
        path: path.join(
          __dirname,
          '../../../src/ListItem/ListItem.Chevron.tsx'
        ),
      },
      {
        name: 'Content',
        path: path.join(
          __dirname,
          '../../../src/ListItem/ListItem.Content.tsx'
        ),
      },
      {
        name: 'Input',
      ...
      },
      {
        ...
        path: path.join(
          __dirname,
          '../../../src/ListItem/ListItem.Swipeable.tsx'
        ),
      },
      {
        name: 'SubTitle',
