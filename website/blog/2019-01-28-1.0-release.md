...
- Change all components that have the `component` prop to `Component` as per convention ([#1479](https://github.com/react-native-training/react-native-elements/pull/1479))
- `<Badge />` Component
...
- `<FormInput />` Component has been renamed to `<Input />` Component ([#497](https://github.com/react-native-training/react-native-elements/pull/497))
- `<Text />` Component
