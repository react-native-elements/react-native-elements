...
```bash
npm install react-native-elements/react-native-elements#base react-native-elements/react-native-elements#themed
```
...
```bash
yarn add react-native-elements/react-native-elements#base react-native-elements/react-native-elements#themed
```
