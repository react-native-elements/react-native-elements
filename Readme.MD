...
*If you are using [Expo](https://expo.io) or [create-react-native-app], click [here](https://github.com/react-native-community/react-native-elements/blob/master/using-with-crna.md)*
