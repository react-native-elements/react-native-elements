...
const Pointer = ({ tooltipY, dimensions, withPointer, pointerColor, pointerStyle, }) => {
...
const HighlightedButton = ({ closeOnlyOnBackdropPress, onPress, style, children, }) => {
    if (!closeOnlyOnBackdropPress) {
        return (React.createElement(Pressable, { testID: "tooltipTouchableHighlightedButton", onPress: onPress, style: style }, children));
    }
    else {
        return (React.createElement(View, { testID: "tooltipTouchableHighlightedButton", style: style }, children));
    }
};
export const Tooltip = (_a) => {
    ...
    React.useEffect(() => {
        ...
        return () => {
            ...
            if (((_a = Platform.constants.reactNativeVersion) === null || _a === void 0 ? void 0 : _a.minor) >= 65) {
                dimensionsListener.remove();
            }
            else if (__DEV__) {
                console.warn('Deprecated API: React native < 0.65.* are no longer supported please use @rneui/base@^4.0.0-rc8 instead.');
            }
        };
    }, [getElementPosition]);
        ...
        React.createElement(ModalComponent, { transparent: true, visible: visible, onShow: onOpen, animationType: animationType },
            React.createElement(TouchableOpacity, { style: {
                ...
                React.createElement(View, null,
                    React.createElement(HighlightedButton, { closeOnlyOnBackdropPress: closeOnlyOnBackdropPress, onPress: handleOnPress, style: TooltipHighlightedButtonStyle }, props.children),
                    React.createElement(Pointer, { tooltipY: tooltipStyle.top, dimensions: dimensions, withPointer: withPointer, pointerColor: pointerColor, pointerStyle: pointerStyle }),
