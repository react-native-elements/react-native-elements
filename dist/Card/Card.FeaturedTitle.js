...
exports.CardFeaturedTitle = void 0;
...
const CardFeaturedTitle = (_a) => {
    ...
    return (<Text_1.default style={react_native_1.StyleSheet.flatten([
        Object.assign({ fontSize: normalizeText_1.default(18), marginBottom: 8, color: (_b = theme === null || theme === void 0 ? void 0 : theme.colors) === null || _b === void 0 ? void 0 : _b.white }, react_native_1.Platform.select({
...
exports.CardFeaturedTitle = CardFeaturedTitle;
exports.CardFeaturedTitle.displayName = 'Card.FeaturedTitle';
