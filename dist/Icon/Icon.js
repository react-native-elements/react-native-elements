...
export const Icon = (_a) => {
    ...
    if (IconComponent === null) {
        return React.createElement(Text, { style: { fontSize: 24 } }, "\u2612");
    }
    return (React.createElement(View, { testID: testID, style: StyleSheet.flatten([
        ...
        React.createElement(Component, Object.assign({ testID: "RNE__ICON__CONTAINER_ACTION", android_ripple: androidRipple(Color(reverse ? color : underlayColor)
                .alpha(0.3)
                .rgb()
                .string()),
            onPress,
            ...
            onPressOut,
            disabled,
            accessibilityRole: 'button' }, pressableProps, rest),
