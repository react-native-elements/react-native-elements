...
exports.SearchBarDefault = void 0;
...
class SearchBarDefault extends react_1.default.Component {
    constructor(props) {
        super(props);
        this.focus = () => {
            this.input.focus();
    ...
    render() {
        ...
        <Input_1.default testID="searchInput" renderErrorMessage={false} {...attributes} onFocus={this.onFocus} onBlur={this.onBlur} onChangeText={this.onChangeText} ref={(input) => {
            this.input = input;
        }} placeholderTextColor={placeholderTextColor} inputStyle={react_native_1.StyleSheet.flatten([
            {
            ...
            round && styles.round,
            inputContainerStyle,
        ])} containerStyle={styles.inputContainer} leftIcon={helpers_1.renderNode(Icon_1.default, searchIcon, defaultSearchIcon(theme))} leftIconContainerStyle={react_native_1.StyleSheet.flatten([
