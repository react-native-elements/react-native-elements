...
export declare type SearchBarIosProps = InputProps & SearchBarBaseProps & typeof SearchBarIOS.defaultProps & {
...
export declare class SearchBarIOS extends Component<SearchBarIosProps & Partial<ThemeProps<SearchBarIosProps>>, SearchBarState> {
    input: TextInput;
    static defaultProps: {
        value: string;
        cancelButtonTitle: string;
